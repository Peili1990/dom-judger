...
<div class="am-cf admin-main">
  ...
  <div class="admin-content">
	...
	<div class="am-g">
		...
		<div class="am-u-sm-6">
			<jsp:include page="authority-component/judger.jsp"></jsp:include>
			
			<jsp:include page="authority-component/dict.jsp"></jsp:include>
			
		</div>
		
		<div class="am-u-sm-6">
			<jsp:include page="authority-component/card.jsp"></jsp:include>
			
			<jsp:include page="authority-component/inv-code.jsp"></jsp:include>			
		</div>
